...
public class instance_TxtManager : MonoBehaviour
{
    ...
    public void SetKeycardChildTexts()
    {
        ...
        {
            Txt_Seviye1.text = "x" + inventorySO.yesilKeycard.ToString();
        ...
        {
            Txt_Seviye2.text = "x" + inventorySO.sariKeycard.ToString();
        ...
        {
            Txt_Seviye3.text = "x" + inventorySO.kirmiziKeycard.ToString();
    ...
    public void SetTheChildTexts()
    {
        ...
        {
            Txt_Array_ChildSayilar[0].text = "x" + inventorySO.Rakam_0.ToString();
        ...
        {
            Txt_Array_ChildSayilar[1].text = "x" + inventorySO.Rakam_1.ToString();
        ...
        {
            Txt_Array_ChildSayilar[2].text = "x" + inventorySO.Rakam_2.ToString();
        ...
        {
            Txt_Array_ChildSayilar[3].text = "x" + inventorySO.Rakam_3.ToString();
        ...
        {
            Txt_Array_ChildSayilar[4].text = "x" + inventorySO.Rakam_4.ToString();
        ...
        {
            Txt_Array_ChildSayilar[5].text = "x" + inventorySO.Rakam_5.ToString();
        ...
        {
            Txt_Array_ChildSayilar[6].text = "x" + inventorySO.Rakam_6.ToString();
        ...
        {
            Txt_Array_ChildSayilar[7].text = "x" + inventorySO.Rakam_7.ToString();
        ...
        {
            Txt_Array_ChildSayilar[8].text = "x" + inventorySO.Rakam_8.ToString();
        ...
        {
            Txt_Array_ChildSayilar[9].text = "x" + inventorySO.Rakam_9.ToString();
