...
public class instance_LittlePeopleController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Rinput = FindObjectOfType<instance_ReadInput>();
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Escape)) { Allow_Input = !Allow_Input; Time.timeScale = Allow_Input ? 1 : 0; }
        ...
        if (BlackBoard_triggered)
            BlackBoard_TriggerEnterMethod();
